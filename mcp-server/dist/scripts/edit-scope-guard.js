...
var RsctConfigSchema = external_exports.object({
  rsct_version: external_exports.string().min(1),
  app: external_exports.object({
    name: external_exports.string().min(1),
    org: external_exports.string().min(1)
  }),
  universe: external_exports.object({
  ...
  public_api: external_exports.array(external_exports.string().min(1)).optional().catch(void 0),
  ...
  mcp: external_exports.object({
    ...
    registered_at: external_exports.string().optional()
  }).optional(),
  approval_modes: RsctApprovalModesSchema.optional(),
  audit: RsctAuditConfigSchema.optional(),
  protected_patterns_extra: external_exports.array(external_exports.string().min(1)).optional(),
  secrets_extra_patterns: external_exports.array(external_exports.string().min(1)).optional()
}).strip();
